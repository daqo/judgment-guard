...
3. **Claim map** — supported facts (with sources), reasonable inferences, speculation, then the evidence sweep laid out per claim: a verdict, and one line per **query** run showing what it was looking for, what it found, and where
